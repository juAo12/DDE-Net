...
from nets.dilated_encoder import DilateEncoder
...
class CenterNet_Resnet50(nn.Module):
    def __init__(self, num_classes = 80, pretrained = False):
        ...
        self.neck = DilateEncoder(2048, 256, 128, 4)
        self.decoder = resnet50_Decoder(256)
    ...
    def forward(self, x):
        ...
        dilate_encoder = self.neck(feat)
        return self.head(self.decoder(dilate_encoder))
